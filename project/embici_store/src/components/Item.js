const Item = ({item}) => {
    return (
        <a href="#" className="m-2 flex flex-col items-center w-full bg-white rounded-lg border shadow-md md:flex-col md:w-2/5 hover:bg-gray-100 dark:border-gray-200 dark:bg-gray-100 dark:hover:bg-gray-200">
